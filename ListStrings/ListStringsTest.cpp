...
public:
      ...
      LenEqual(int lenght); 
      LenEqual(int lenght,int litnodecount); 
...
int main() {
	...
	list::iterator i1(l1.begin());
    list::iterator i2(l1.end());
    list::iterator i3;
    list::value_type e1; // !!!
...
LenEqual::LenEqual(int lenght,int litnodecount){
    lenghtstring = lenght;
    lengthlist = litnodecount;
}
